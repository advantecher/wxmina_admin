							...
							<TBODY>
									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/UserOfMinaAction_list"
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 白洋湾配置</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath}/PlanConsumeOfBywAction_show"
														target=main>－ 计划消耗指标</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
