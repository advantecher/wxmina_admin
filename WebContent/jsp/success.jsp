...
<BODY>
	...
	<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
		<TBODY>
			<tr>
				<TD width=15 background="/admin/images/new_022.jpg"><IMG
					height="100%" src="/admin/images/new_022.jpg" border=0></TD>
				...
				<TD width=15 background="/admin/images/new_023.jpg"><IMG
				 src="/admin/images/new_023.jpg" border=0></TD>
			</tr>
		</TBODY>
	</table>
	<TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
